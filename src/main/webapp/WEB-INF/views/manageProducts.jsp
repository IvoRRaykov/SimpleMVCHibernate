            ...
            <td>
                <c:if test="${not empty productToUpdate.code}">
                    ...
                    <c:if test="${not empty errorString}">
                        <div class="error"></div><p> ${errorString}</p>
                    </c:if>
        ...
        <table class="tg">
            ...
            <c:forEach items="${productList}" var="product">
                <tr>
                    ...
                    <td align="center">
                        <c:if test="${product.forSale==true}"><img class="no_border" id="icon" src="${pageContext.request.contextPath}/../resources/icons/y.ico"></c:if>
                        <c:if test="${product.forSale!=true}"><img class="no_border" id="icon" src="${pageContext.request.contextPath}/../resources/icons/x.png"></c:if></td>
                    <td align="center"><a href="<c:url value='/product/update/${product.code}' />"><img class="no_border" id="icon" src="${pageContext.request.contextPath}/../resources/icons/settings.ico"></a></td>
                    <td align="center"><a href="<c:url value='/product/remove/${product.code}' />"><img class="no_border" id="icon" src="${pageContext.request.contextPath}/../resources/icons/trash.png"></a></td>
                </tr>
            </c:forEach>
        </table>
    </c:if>
